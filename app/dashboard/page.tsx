...
export default function Dashboard() {
  ...
  const pendingDocuments = documents.filter(doc => doc.status === "PENDING" || doc.status === "IN_REVIEW").length
                          ...
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-500">
                                {doc.upload_date ? new Date(doc.upload_date).toLocaleDateString('es-ES') : ''}
                              </p>
                            </div>
                          </div>
                          <div className="flex items-center space-x-3">
